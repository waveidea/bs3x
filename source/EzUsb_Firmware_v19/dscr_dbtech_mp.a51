...
StandardAcIntrfcDscr:
		...
		db	0		;; Interface class  (AUDIO)
		db	0		;; Interface sub class  (AC:audio control)
...
*/
;B4.2 1.0		 Interface 1: MIDI Streaming, class specific header
MSCIntrfcDscr:
...
; 1.2			 Interface 1: MIDI Streaming, class specific MIDI IN, Ext.
MIDIInExDscr:
...
MIDIOutEm2Dscr:
		...
		db	0		;; unused
MIDIOutEm2DscrEnd:
*/							//Interface 1: MIDI Streaming, class specific MIDI OUT, Emb
;B4.4 1.6 //////////////////// MIDI OUT 1 /////////////////////////////
MIDIOutExDscr:
...
;B5.2 1.7 //////////////////// ENDPOINTS /////////////////////////////
//Enpoint 1 : EP direction,type of transfer(bulk,ISO,...), IT interval
